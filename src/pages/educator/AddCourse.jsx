    ...
    if (action === 'add') {
      ...
      setChapters((prev) =>
        prev.map((ch) => {
          ...
          const updatedContent = ch.chapterContent.filter((_, i) => i !== lectureIndex);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        `${backendUrl}/api/educator/add-course`, formData,
  ...
  return (
    <div className="h-screen overflow-scroll flex flex-col items-start md:p-8 p-4 pt-8">
      ...
      >
        ...
        <div
          className="flex justify-center items-center bg-blue-100 p-2 rounded-lg cursor-pointer mb-4"

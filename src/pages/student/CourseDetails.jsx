...
<p className='text-sm'>Course by <span className='text-blue-600 underline'>Engr Mutiu</span></p>
...
<div className='py-20 text-sm md:text-default'>
  ...
  <p><p  className ='pt-3  rich-text' dangerouslySetInnerHTML={{__html: courseData.courseDescription}}></p></p>
</div>

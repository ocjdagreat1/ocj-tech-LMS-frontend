...
<p className=' py-4 text-center text-xs md:text-sm text-white/60'>Copyright 2026 ©

  <span className="text-red-400">OCJ TECH</span>
,All Right Reserved. Powered by Opara Chibuike Justine</p>
